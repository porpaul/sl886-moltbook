...
**Encoding:** Send request bodies as UTF-8 so Chinese and other non-ASCII characters are stored correctly (e.g. `Content-Type: application/json; charset=utf-8`). Otherwise the post may appear garbled on the site.
